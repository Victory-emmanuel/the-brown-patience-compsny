            ...
            <div className=" mb-6">
              ...
              <div className=" sm:px-12 xx:px-6 ">
                <p className="mb-6 font-medium  lg:text-lg text-primary lg:text-left md:text-lg md:text-center">
                  ...
                  when pornography found me. Or maybe I found it. And it held me
                  tight till I turned to Jesus at 15. But turning to Jesus
                  didn't give me a mind wipe. All the porn stored in my mind, my
                  memory, did not disappear. So though I stopped watching more
                  porn videos, my mind still had its memories, its archive. It
                  still knew how to create its own series, to make its own
                  fantasies. Even though I was now a Believer.
                </p>
                <p className="mb-6 font-medium  lg:text-lg text-primary lg:text-left md:text-lg md:text-center">
                  I didn't know how to stop them, how to quit thinking dirty,
                  pulse-increasing thoughts! And I was desperate to be free. “Oh
                  God, will I think these kinds of thoughts forever?”
                </p>
                <p className="mb-6 font-medium  lg:text-lg text-primary lg:text-left md:text-lg md:text-center">
                  Hell no! He taught me to tell them “No!” It's what His Word
                  said He'd do in Titus 2:11 & 12 — literally, word for word!
                ...
                <p className="mb-6 font-medium  lg:text-lg text-primary lg:text-left md:text-lg md:text-center">
                  ...
                  tell ungodly thoughts “No!” to take control of my thoughts, to
                  have my mind renewed by His Word. And He can teach you too!
                  Oh, He can make you free. So free that you'd struggle to
                  remember what used to be compulsions.
                </p>
                <p className="mb-12 font-medium lg:text-lg text-primary lg:text-left md:text-lg md:text-center">
                  Totally without planning to, I chronicled my experience in the
                  book So He Taught Me 'No'. “Weren't you ashamed to write about
                  these things?” Not one bit! Cause it's so much more important
                  to have my freedom replicated in the lives of my brothers and
                  sisters in Christ than to present a perfect image of myself.
                </p>
                <p className="mb-12 font-medium lg:text-lg text-primary lg:text-left md:text-lg md:text-center">
                  And that's how the Oasis came about. <br /> An Oasis, by
                  definition, is a body of water in a desert. God's Word is an
                  Oasis. It refreshes. It washes clean. No matter the dirt our
                  minds have been covered in, no matter the level of vile in our
                  thoughts, no matter the depth of our addictions, God's Word
                  can wash that mind so clean, make it so new that its past
                  becomes a fading memory.
                </p>
                <p className="mb-12 font-medium lg:text-lg text-primary lg:text-left md:text-lg md:text-center">
                  Oasis is a mind renewal centre. It focuses on thoughts, the
                  mind, and the God who can renew. You can download these mind
                  books for free:
                </p>
              </div>
            </div>
