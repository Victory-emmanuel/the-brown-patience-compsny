          ...
          <div id=" ">
            ...
            <div id=" Mercy-Adegbenro." className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                ...
                <p className="mb-4">
                  Coach did not stop at helping me express myself better through
                  writing but broke things down and made me understand why I am
                  writing the story, who my audience is, the feelings and
                  emotions put into writing, what makes the story catchy and
                  keeps the reader going and so on.
                </p>
                <p className="mb-4">
                  The depth of the lectures would definitely keep me going for a
            ...
            <div id=" Timilehin-Oyinloye." className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                ...
                <p className="mb-4">
                  So I was actually looking for a way I could learn it. Thank
                  God for Aanu. Though, by the time she was telling me about
                  this class, I wasn't really getting the full concept of the
                  course, but I saw it as a way to improve myself. So I joined
                  since I knew that I'd gain something plus keep myself busy and
                  add value to my life during my first semester holiday.
                </p>
                <p className="mb-4">
                  When I joined this class, you were able to open my eyes to the
            ...
            <div id=" Kehinde-Adedoyin." className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                ...
                <p className="mb-4">
                  Now, whenever I write or respond to messages, I put everything
                  I've learned into practice. I'm able to clearly express my
                  thoughts in writing while keeping in mind the audience I'm
            ...
            <div id=" Chimamanda-Okoye" className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                ...
                <p className="mb-4">
                  I was able to learn how to understand my audience and the way
            ...
            <div id=" Sharon-Akintade" className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                <p className="mb-4">
                  ...
                  plenty things in my head in a way people understand.
                </p>
                <p className="mb-4">
                  After the course, which ended 28th October 2023, I can say
                  this course exceeded my expectations. I've gotten an
            ...
            <div id=" Onyinyechi-CeeCee" className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                <p className="mb-4">
                  ...
                  indeed a value packed training.
                </p>
                <p className="mb-4">
                  There was a mind shift, which made it very much easier. I've
                  learnt a lot and I intend to keep practicing, to be the best
            ...
            <div id=" Lily-Josiah" className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                ...
                <p className="mb-4">
                  ...
                  storytelling, it has also shown me valuable emphases that I
            ...
            <div id=" Oreoluwa-Dawodu" className={`relative p-4`}>
              ...
              <div className="text-secondary dark:text-primary">
                <p className="mb-4">
                  ...
                  This class also made me learn that I have to understand what
                  my audience likes and understand the kind of audience I’m
                  talking to.
                </p>
                <p className="mb-4">
